...
import ch.johannes.example.data.schema.routines.UuidGenerateV1;
import ch.johannes.example.data.schema.routines.UuidGenerateV1mc;
import ch.johannes.example.data.schema.routines.UuidGenerateV3;
import ch.johannes.example.data.schema.routines.UuidGenerateV4;
import ch.johannes.example.data.schema.routines.UuidGenerateV5;
import ch.johannes.example.data.schema.routines.UuidNil;
import ch.johannes.example.data.schema.routines.UuidNsDns;
import ch.johannes.example.data.schema.routines.UuidNsOid;
import ch.johannes.example.data.schema.routines.UuidNsUrl;
import ch.johannes.example.data.schema.routines.UuidNsX500;
