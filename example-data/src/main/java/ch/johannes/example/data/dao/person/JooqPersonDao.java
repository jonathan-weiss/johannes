...
import ch.johannes.example.data.jooq.JooqAbstractRepository;
...
@ApplicationScoped
public class JooqPersonDao extends JooqAbstractRepository implements PersonDao {

    @Override
    public List<Person> getAllPerson() {
        final Result<PersonRecord> personRecords = execute(dslContext -> dslContext.selectFrom(PERSON).fetch());
