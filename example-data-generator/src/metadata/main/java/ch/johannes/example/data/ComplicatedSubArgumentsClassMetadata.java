...
public class ComplicatedSubArgumentsClassMetadata {
  ...
  public static final ClassDescriptor CLASS_DESCRIPTOR = ClassDescriptor.of(PACKAGE_DESCRIPTOR,"ComplicatedSubArgumentsClass").addField(MY_SPECIAL_FIELD).addField(MY_NORMAL_FIELD);

  public static final ClassDescriptor COMPLICATED_SUB_ARGUMENTS_CLASS_DESCRIPTOR = CLASS_DESCRIPTOR;
}
