...
public class ComplicatedClassMetadata {
  ...
  public static final ClassDescriptor CLASS_DESCRIPTOR = ClassDescriptor.of(PACKAGE_DESCRIPTOR,"ComplicatedClass").addField(MY_FLOATING_SUPER_FIELD).addField(MY_SPECIAL_FIELD);

  public static final ClassDescriptor COMPLICATED_CLASS_DESCRIPTOR = CLASS_DESCRIPTOR;
}
