...
public class PersonMetadata {
  ...
  public static final FieldDescriptor NICKNAMES = FieldDescriptor.of("nicknames", TypeDescriptor.of(PackageDescriptor.of("java.lang"), ClassnameDescriptor.of("List"), false, false, CollectionUtil.<TypeDescriptor>listOf(TypeDescriptor.of(PackageDescriptor.of("java.lang"), ClassnameDescriptor.of("String"), false, false, CollectionUtil.<TypeDescriptor>listOf()))));

  public static final FieldDescriptor STUPID_MAP = FieldDescriptor.of("stupidMap", TypeDescriptor.of(PackageDescriptor.of("java.lang"), ClassnameDescriptor.of("Map"), false, false, CollectionUtil.<TypeDescriptor>listOf(TypeDescriptor.of(PackageDescriptor.of("java.lang"), ClassnameDescriptor.of("String"), false, false, CollectionUtil.<TypeDescriptor>listOf()),TypeDescriptor.of(PackageDescriptor.of("java.lang"), ClassnameDescriptor.of("Integer"), false, false, CollectionUtil.<TypeDescriptor>listOf()))));
}
